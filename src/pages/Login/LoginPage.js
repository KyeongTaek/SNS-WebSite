...
// import { go_post_request } from "../../Services/BoardService";
function LoginPage() {
      ...
      <div className="Container">
        <div className="loginFrame">
          ...
          <form onSubmit={doLogin} name="fo">
            ...
            <ul>
              <li>
                <a className="loginpage" href="../idSearch">
                  아이디 찾기
                </a>
              </li>
              <li>|</li>
              <li>
                <a className="loginpage" href="../pwSearch">
                  비밀번호 찾기
                </a>
              </li>
              <li>|</li>
              <li>
                <a className="loginpage" href="../join">
                  회원가입
                </a>
              </li>
            </ul>
